...
- [ ] **3 — Statement ingestion.** CSV and OFX-lite parsers, column inference,
...
263 tests green, typecheck clean.

## Known gaps

- CI is not wired up yet. The intended pipeline is `npm run typecheck`,
